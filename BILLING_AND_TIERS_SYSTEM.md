...
flowchart TD
    subgraph Cost_Analysis ["💰 Cost & Profit Analysis (Per Device/Month)"]
        ...
        C_Pro["Storage: 658 MB<br/>Cost: ~3.20 ฿<br/>Revenue: 99 ฿<br/>Stripe Fee: ~13.61 ฿<br/>Net Profit: 82.19 ฿ (83%)"]
        C_Ent["Storage: 2,704 MB<br/>Cost: ~16.0 ฿<br/>Revenue: 299 ฿<br/>Stripe Fee: ~20.91 ฿<br/>Net Profit: 262.09 ฿ (88%)"]
...
| คำถาม | คำตอบ |
|:-------|:------|
| **ทำไม 99 ฿/เครื่อง/เดือน?** | ต้นทุน Storage ต่อ device (90 วัน data, 1 วินาที) ใช้พื้นที่ประมาณ 658 MB → คิดเป็นต้นทุน VPS ~3.20 ฿/เครื่อง/เดือน, เมื่อรวมค่าธรรมเนียม Stripe (~13.61 ฿) ราคา 99 ฿ ให้ Net Margin ~83% สำหรับ operation + profit |
...
| **ทำไม 299 ฿?** | ต้นทุน Storage 1 ปี/device ≈ 2.7 GB compressed (ต้นทุน VPS ~16 ฿). เมื่อรวมค่าธรรมเนียม Stripe (~20.91 ฿) และค่า backup, redundancy, support → ราคา 299 ฿ ให้ Net Margin ~88% ที่ยั่งยืน |
...
#### 🟣 กลุ่มองค์กร (Enterprise Tier: 299 ฿/เดือน) — เก็บข้อมูลดิบ 1 ปี
...
> **ความคุ้มค่า (Profit Margin):** ต้นทุนข้อมูลองค์กรอยู่ที่ 16.0 บาท ในขณะที่คุณเก็บค่าบริการ 299 บาท/เดือน (หรือมากกว่า) กำไรขั้นต้นส่วนนี้ยังคงสูงมากถึง **94%** 
...
flowchart TD
    ...
    subgraph Users ["👥 Customer Base (Total 1,000 Devices)"]
        ...
        U_Ent["Enterprise (5%)<br/>50 Devices<br/>Revenue: 14,950 ฿"]
    end
    ...
    Profit["✅ Gross Profit: 28,200 ฿ / Month"]
    Users --> Profit
```
...
| **Enterprise** (299฿)| 15 | 2.71 GB | 40.6 GB | 4,485 ฿ |
| **รวมทั้งหมด** | **300**| - | **76.2 GB**| **7,950 ฿ / เดือน** |

- **ทรัพยากรที่ต้องใช้:** `KVM 2` (ราคา 419 ฿/เดือน, ได้พื้นที่ NVMe 100 GB ซึ่งครอบคลุม 76.2 GB ได้พอดี)
- **กำไรขั้นต้น (Gross Profit):** 7,950 - 419 = **7,531 ฿ / เดือน (กำไร ~94%)**
...
| **Enterprise** (299฿)| 50 | 2.71 GB | 135.5 GB | 14,950 ฿ |
| **รวมทั้งหมด** | **1,000**| - | **274.5 GB**| **29,800 ฿ / เดือน** |

- **ทรัพยากรที่ต้องใช้:** `KVM 8` (ต้นทุน 1,600 ฿/เดือน, พื้นที่ 400 GB)
- **กำไรขั้นต้น (Gross Profit):** 29,800 - 1,600 = **28,200 ฿ / เดือน (กำไร ~94%)**
...
| **Enterprise** (299฿)| 250 | 2.71 GB | 677.5 GB | 74,750 ฿ |
| **รวมทั้งหมด** | **5,000**| - | **1,372.5 GB (1.37 TB)**| **149,000 ฿ / เดือน** |

- **ทรัพยากรที่ต้องใช้:** `VPS Cluster / Bare Metal Server` (ต้นทุนรวมประมาณ 8,000 ฿/เดือน)
- **กำไรขั้นต้น (Gross Profit):** 149,000 - 8,000 = **141,000 ฿ / เดือน (กำไร ~94%)**
...
3. **Enterprise Tier:** การเก็บข้อมูล 1 ปี ใช้พื้นที่ 2.71 GB ต้นทุนพุ่งขึ้นเป็น **16 บาท** แต่เนื่องจากเราเก็บค่าบริการกลุ่มนี้สูง (299 ฿) ทำให้กลายเป็น Tier ที่ดึงเงินเข้าบริษัทได้มากที่สุดต่อเครื่อง
...
flowchart TD
    ...
    Check -->|Enterprise Tier| T_Ent["SLA: 99.9%<br/>ชดเชย: คืนเงินค่ารายเดือน 1-3 เดือน<br/>(สูงสุด 897 บาท)"]
...
* **กลุ่ม Enterprise Tier (299 ฿+/เดือน):**
